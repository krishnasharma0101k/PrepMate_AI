...
import { button, tr } from "motion/react-client";
      ...
      >
        <div className="mx-auto flex h-12 max-w-7xl items-center justify-between px-3 sm:px-5">
          ...
          <button
            ...
            className="flex h-8 items-center justify-center gap-2 rouded-lg border border-black/15 text-black/60 transition px-2 hover:border-[#0A0A0A] hover:text-[#0A0A0A]"
          >
            <FiEye size={13} />
          </button>
        </div>
        ...
        <div className="mx-auto w-full max-w-2xl">
          ...
          ${
            ...
            {isLastStep ? (
              <button
                onClick={() => setShowPreview(true)}
                className="flex items-center gap-1.5 px-3.5 py-2 rounded-lg text-xs font-semibold bg-[#0A0A0A]/90 backdrop-blur-2xl border border-white/10 text-white shadow-[0_8px_24px_rgba(0,0,0,0.25)] hover:border-white/20 transition-all"
              >
                <FiEye size={13} />
